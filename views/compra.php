    ...
    <div class="container mt-5 mb-5 border">
        ...
        <form id="formCompra" action="generar_venta.php" method="POST">
            ...
            <div id="camposEnvio">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="envioTitular" id="envioTitular"
                        placeholder="Máximo Cozzetti" pattern="^[A-Za-záéíóúÁÉÍÓÚ ]+$" minlength="3" maxlength="50"
                        required>
                    <div id="errorNombre" class="invalid-feedback">El nombre debe: Tener 2 palabras, contener entre 3 y
                        50 caracteres y ser solamente letras.</div>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <div id="errorAltura" class="invalid-feedback">La altura debe: Ser numérica y estar comprendida
                        entre N° 1 - 99999</div>
                </div>
                <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" name="dni" id="dni" placeholder="Solo números, sin puntos."
                    min="999999" max="99999999" required>
                ...
                <div id="tarjetaContainer">
                    <label for="tarjeta" class="col-form-label">PAGAR CON TARJETA:<br>Ingrese el número de su tarjeta registrada en
                        MercadoPago:</label>
                    <input type="number" class="form-control" name="tarjeta" id="tarjeta"
                        placeholder="1234 5678 1234 (12 digitos)" min="100010001000" max="999999999999" required>
