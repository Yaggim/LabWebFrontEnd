...
function completarDatosPagina() {
    ...
    document.getElementById("producto-image1").src =  `/${basePath}/public/${producto.imagenes[0]}`;
    document.getElementById("producto-image2").src = `/${basePath}/public/${producto.imagenes[1]}`;
...
function completarDatosCombo() {
    ...
    document.getElementById("combo-image1").src =  `/${basePath}/public/${combo.imagenes[0]}`;
