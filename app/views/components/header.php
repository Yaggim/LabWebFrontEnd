            ...
            <div class="row justify-content-center align-items-center">
                ...
                <div class="offcanvas offcanvas-start " tabindex="-1" id="offcanvasTop" aria-labelledby="offcanvasTopLabel" data-bs-theme="dark">
                    ...
                    <div class="offcanvas-body pt-3 pb-0" >
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link py-3 px-5" href="/<?php echo CARPETA_PROYECTO ?>/ofertas-semana">Ofertas</a>
                            </li>
                ...
                <div class="col-auto d-flex justify-content-end">
                    ...
                    <form method="POST" class="dropdown-menu p-4 form-login" id="btnDropdownLogin" >
                        <?php if (!$usuario->isLoggedIn()): require RUTA_PROYECTO.'/app/views/components/form_login.php'; ?>
                        <?php else: require RUTA_PROYECTO.'/app/views/components/form_logout.php'; ?>
                        <?php endif; ?>
                    </form>
    ...
    <nav class="navbar navbar-expand-md navbar-dark second-navbar d-none d-lg-block">
        <div class="" id="navbarNav">
            <ul class="navbar-nav d-flex justify-content-evenly ">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/<?php echo CARPETA_PROYECTO ?>/ofertas-semana">Ofertas</a>
                </li>
                <li class="nav-item dropdown">
