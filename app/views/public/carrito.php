...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/<?php echo CARPETA_PROYECTO ?>/public/css/public/carrito.css">
    <script type="text/javascript" src="/<?php echo CARPETA_PROYECTO ?>/public/js/public/carrito.js" defer></script>
    <script type="text/javascript" src="/<?php echo CARPETA_PROYECTO ?>/public/js/public/productos.js" defer></script>
</head>
            ...
            <!-- Aquí se agregarán los elementos del carrito dinámicamente -->
             <div id="carrito" class="border mt-3 mb-3 p-3"></div>
                <div class="d-flex flex-column align-items-end mb-3">   
                    <form id="comprar" action="/<?php echo CARPETA_PROYECTO ?>/finalizar-compra" method="POST">
