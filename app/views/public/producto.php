...
<head>
    ...
    <script type="text/javascript" src="/<?php echo CARPETA_PROYECTO ?>/public/js/public/producto.js" defer></script>
</head>
        ...
        <div class="row">
            ...
            <div class="col-6 h-100 p-2">
                ...
                <div class="col-12 p-2 text-center rounded">
                    <form id="comprar" action="/<?php echo CARPETA_PROYECTO ?>/app/views/public/compra.php" method="POST">
                ...
                <div class="p-2 my-2 border rounded text-center">
                    ...
                    <img src="/<?php echo CARPETA_PROYECTO ?>/public/images/mediopago1.png">
                </div>
            </div>
